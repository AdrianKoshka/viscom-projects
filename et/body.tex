...
\paragraph{}
	\begin{description}
		\item [Font:] A complete assortment of type of one style. \cite{Dictionary.com2017font}
		\item [Font Families:] Collections of closely related typeface designs. \cite{wiki:typeface2017}
		\item [Gylph:] A glyph is an element of writing.  \cite{wiki:glyph2017}
			\begin{item}
				\item Example: the ligature 'æ' in archæology represents a and e letters.
			\end{item}
	\end{description}
\par
